...
# Workflow name
parser.add_argument("--workflow_name", "--workflow", default="GATK RNAseq", help="Workflow name. Change if in a custom workspace the name of workflow is different. Default: 'GATK RNAseq'.")
    ...
    workflow_params = [
        {
            ...
            "dataItemEmbedded":{
                ...
                "data":{
                    ...
                    "s3Prefix":"pipelines/CalliNGS-NF-data/reads"
                }
            }
        },
        {
            ...
            "dataItemEmbedded":{
                ...
                "data":{
                    "name":"genome.fa",
                    "s3BucketName":"lifebit-featured-datasets",
                    "s3ObjectKey":"pipelines/CalliNGS-NF-data/genome.fa"
                }
            }
        },
        {
            ...
            "dataItemEmbedded":{
                "type":"S3File",
                "data":{
                    "name":"known_variants.vcf.gz",
                    "s3BucketName":"lifebit-featured-datasets",
                    "s3ObjectKey":"pipelines/CalliNGS-NF-data/known_variants.vcf.gz"
                }
            }
        },
        {
            ...
            "dataItemEmbedded":{
                ...
                "data":{
                    "name":"blacklist.bed",
                    "s3BucketName":"lifebit-featured-datasets",
                    "s3ObjectKey":"pipelines/CalliNGS-NF-data/blacklist.bed"
                }
            }
        }
    ]
